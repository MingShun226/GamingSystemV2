-- COMPLETE SQL IMPORT FOR SUPABASE
-- Execute this entire file in Supabase SQL Editor

-- 1. First, ensure marketing_source column exists in wager_wave_users table
ALTER TABLE public.wager_wave_users 
ADD COLUMN IF NOT EXISTS marketing_source VARCHAR(100);

-- 2. Create promotional_codes table to store marketing referral codes
...
-- 3. Create marketing_registrations table to track user registrations from promotional codes
...
-- 5. Insert default promotional codes
